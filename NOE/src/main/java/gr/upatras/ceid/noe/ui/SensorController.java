...
public class SensorController extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(616, 409));

        jPanel1.setBackground(new java.awt.Color(219, 255, 255));

        jLabel3.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel3.setText("Διαχείριση Αισθητήρα");

        jButton4.setBackground(new java.awt.Color(255, 255, 255));
        jButton4.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jButton4.setText("Ενεργοποίηση");
        ...
        jButton5.setText("Απενεργοποίηση");
        ...
        jButton7.setText("Έναρξη Σάρωσης");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SensorController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SensorController().setVisible(true);
            }
        });
    }
